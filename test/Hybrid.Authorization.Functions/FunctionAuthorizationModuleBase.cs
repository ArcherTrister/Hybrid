// -----------------------------------------------------------------------
//  <copyright file="FunctionAuthorizationModuleBase.cs" company="Hybrid开源团队">
...
namespace Hybrid.Authorization
{
    ...
    public abstract class FunctionAuthorizationModuleBase<TFunctionAuthorizationManager, TFunctionAuthorization, TFunctionAuthCache, TModuleHandler,
        TFunction, TFunctionInputDto,
        TModule, TModuleInputDto, TModuleKey, TModuleFunction, TModuleRole, TModuleUser, TRoleKey, TUserKey> : AspHybridModule

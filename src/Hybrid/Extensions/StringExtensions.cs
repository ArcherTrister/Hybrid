// -----------------------------------------------------------------------
//  <copyright file="StringExtensions.cs" company="cn.lxking">
...
namespace Hybrid.Extensions
{
    ...
    public static class StringExtensions
    {
        ...
        /// <returns></returns>
        public static long ToInt64(this string me, NumberStyles style, long defaultValue)
        {
            //long? value = me.ToInt64(style);
            //return value == null ? defaultValue : value.Value;
            try
            {
                return long.Parse(me, style);
            }
            catch (Exception)
            {
                return defaultValue;

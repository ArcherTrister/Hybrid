// -----------------------------------------------------------------------
//  <copyright file="HybridHub.cs" company="Hybrid开源团队">
...
namespace Hybrid.AspNetCore.SignalR
{
    ...
    /// HybridHub基类
    /// </summary>
    public abstract class HybridHub : Hub
    {
        /// <summary>
        /// 初始化一个<see cref="HybridHub"/>类型的新实例
        /// </summary>
        protected HybridHub(IConnectionUserCache userCache)
        {
            UserCache = userCache;
        }
    ...
    public abstract class HybridHub<T> : HybridHub where T : class
    {

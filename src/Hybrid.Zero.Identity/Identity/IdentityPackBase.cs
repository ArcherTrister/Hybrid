// -----------------------------------------------------------------------
//  <copyright file="IdentityPackBase.cs" company="Hybrid开源团队">
...
namespace Hybrid.Identity
{
    ...
    public abstract class IdentityPackBase<TUserStore, TRoleStore, TUser, TUserKey, TUserClaim, TUserClaimKey, TRole, TRoleKey> : HybridPack
            ...
            services.Replace(new ServiceDescriptor(typeof(IPrincipal),
                provider =>
                {
                    ...
                    if (principal != null && principal.Identity is ClaimsIdentity identity)
                    {
                        ...
                        if (property != null)
                        {
                            identity.AddClaim(new Claim(HybridConstants.UserIdTypeName, property.PropertyType.FullName));
                        }
                    }

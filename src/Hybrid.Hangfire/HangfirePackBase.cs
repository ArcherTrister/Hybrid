// -----------------------------------------------------------------------
//  <copyright file="HangfirePackCore.cs" company="Hybrid开源团队">
...
namespace Hybrid.Hangfire
{
    ...
    public abstract class HangfirePackBase : AspHybridPack
    {
        /// <summary>
        /// 获取 模块级别，级别越小越先启动
        /// </summary>
        ...
        public override void UsePack(IApplicationBuilder app)
        {
            ...
            string url = configuration["Hybrid:Hangfire:DashboardUrl"].CastTo("/hangfire");
        ...
        protected virtual Action<IGlobalConfiguration> GetHangfireAction(IServiceCollection services)
        {
            ...
            string storageConnectionString = configuration["Hybrid:Hangfire:StorageConnectionString"].CastTo<string>();
        ...
        protected virtual BackgroundJobServerOptions GetBackgroundJobServerOptions(IConfiguration configuration)
        {
            ...
            int workerCount = configuration["Hybrid:Hangfire:WorkerCount"].CastTo(0);
            if (workerCount > 0)
            {
        ...
        {
            string[] roles = configuration["Hybrid:Hangfire:Roles"].CastTo("").Split(",", true);

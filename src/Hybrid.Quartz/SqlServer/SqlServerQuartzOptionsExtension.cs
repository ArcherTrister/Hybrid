...
{
    internal class SqlServerQuartzOptionsExtension : IQuartzOptionsExtension
    {
        private readonly Action<SqlServerQuartzOptions> _sqlServerQuartzOptions;

        public SqlServerQuartzOptionsExtension(Action<SqlServerQuartzOptions> sqlServerQuartzOptions)
        {
            _sqlServerQuartzOptions = sqlServerQuartzOptions;
        }

        public void AddServices(IServiceCollection services)
        {
            var sqlServerQuartzOptions = new SqlServerQuartzOptions();

            _sqlServerQuartzOptions?.Invoke(sqlServerQuartzOptions);

            services.AddSingleton(sqlServerQuartzOptions);
        ...
        protected NameValueCollection SetProperties(SqlServerQuartzOptions sqlServerQuartzOptions)
        {

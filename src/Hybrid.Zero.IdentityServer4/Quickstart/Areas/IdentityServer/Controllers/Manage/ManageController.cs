...
{
    [HybridDefaultUI(typeof(ManagController<,>))]
    public abstract class ManagController : IdentityServerBaseController
    {
    }
    ...
    [Area("IdentityServer")]
    ////[Route("Manage")]
    [Route("IdentityServer/[controller]/[action]")]
    [Authorize]
    public class ManagController<TUser, TKey> : ManagController
    ...
    where TKey : IEquatable<TKey>
    {
        ...
        public ManagController(UserManager<TUser> userManager, SignInManager<TUser> signInManager, 

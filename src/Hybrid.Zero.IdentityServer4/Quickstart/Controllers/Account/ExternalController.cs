// -----------------------------------------------------------------------
//  <copyright file="ExternalController.cs" company="cn.lxking">
...
namespace Hybrid.Zero.IdentityServer4.Quickstart
{
    ...
    where TUserKey : IEquatable<TUserKey>
    {
        ...
        private async Task<(TUser user, string provider, string providerUserId, IEnumerable<Claim> claims)> FindUserFromExternalProvider(AuthenticateResult result)
        {

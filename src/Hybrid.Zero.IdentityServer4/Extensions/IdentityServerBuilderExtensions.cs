...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static class IdentityServerBuilderExtensions
    {
            ...
            where TUserKey : IEquatable<TUserKey>
        {
            ...
            if (partManager == null)
            {
                throw new InvalidOperationException("\"AddHybridDefaultUI\" must be after \"AddMvc\".");
            }
...
builder.Services.GetOrAddTypeFinder<IHybridDefaultUIAttributeTypeFinder>(assemblyFinder => new HybridDefaultUIAttributeTypeFinder(assemblyFinder));
            ...
            partManager.ApplicationParts.Add(new HybridControllerApplicationPart(typeFinder.GetTypeInfos(), typeof(TUser), typeof(TUserKey)));

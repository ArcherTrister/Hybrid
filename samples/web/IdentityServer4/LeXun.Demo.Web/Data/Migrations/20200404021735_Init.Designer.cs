...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LeXun.Demo.Authorization.Entities.EntityRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LeXun.Demo.Authorization.Entities.EntityUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LeXun.Demo.Authorization.Entities.Module", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LeXun.Demo.Authorization.Entities.ModuleFunction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LeXun.Demo.Authorization.Entities.ModuleRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LeXun.Demo.Authorization.Entities.ModuleUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LeXun.Demo.Identity.Entities.LoginLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LeXun.Demo.Identity.Entities.Organization", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LeXun.Demo.Identity.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LeXun.Demo.Identity.Entities.RoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LeXun.Demo.Identity.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LeXun.Demo.Identity.Entities.UserClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LeXun.Demo.Identity.Entities.UserDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LeXun.Demo.Identity.Entities.UserLogin", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LeXun.Demo.Identity.Entities.UserRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LeXun.Demo.Identity.Entities.UserToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LeXun.Demo.Infos.Entities.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LeXun.Demo.Infos.Entities.MessageReceive", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LeXun.Demo.Infos.Entities.MessageReply", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LeXun.Demo.Systems.Entities.AuditEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LeXun.Demo.Systems.Entities.AuditOperation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LeXun.Demo.Systems.Entities.AuditProperty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LeXun.Demo.Authorization.Entities.EntityRole", b =>
                {
                    ...
                    b.HasOne("LeXun.Demo.Identity.Entities.Role", "Role")
                        .WithMany()
            ...
            modelBuilder.Entity("LeXun.Demo.Authorization.Entities.EntityUser", b =>
                {
                    ...
                    b.HasOne("LeXun.Demo.Identity.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("LeXun.Demo.Authorization.Entities.Module", b =>
                {
                    b.HasOne("LeXun.Demo.Authorization.Entities.Module", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("LeXun.Demo.Authorization.Entities.ModuleFunction", b =>
                {
                    ...
                    b.HasOne("LeXun.Demo.Authorization.Entities.Module", "Module")
                        .WithMany()
            ...
            modelBuilder.Entity("LeXun.Demo.Identity.Entities.Organization", b =>
                {
                    b.HasOne("LeXun.Demo.Identity.Entities.Organization", null)
                        .WithMany()
                        .HasForeignKey("ParentId");
                });
            ...
            modelBuilder.Entity("LeXun.Demo.Identity.Entities.Role", b =>
                {
                    b.HasOne("LeXun.Demo.Infos.Entities.Message", null)
            ...
            modelBuilder.Entity("LeXun.Demo.Identity.Entities.UserDetail", b =>
                {
                    b.HasOne("LeXun.Demo.Identity.Entities.User", "User")
                        .WithOne("UserDetail")
                        .HasForeignKey("LeXun.Demo.Identity.Entities.UserDetail", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("LeXun.Demo.Infos.Entities.Message", b =>
                {
                    b.HasOne("LeXun.Demo.Identity.Entities.User", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("LeXun.Demo.Infos.Entities.MessageReceive", b =>
                {
                    b.HasOne("LeXun.Demo.Infos.Entities.Message", "Message")
                        .WithMany("Receives")
                        .HasForeignKey("MessageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LeXun.Demo.Infos.Entities.MessageReply", b =>
                {
                    b.HasOne("LeXun.Demo.Infos.Entities.Message", "BelongMessage")
                        .WithMany()
                        .HasForeignKey("BelongMessageId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("LeXun.Demo.Infos.Entities.Message", "ParentMessage")
                        .WithMany("Replies")
                        .HasForeignKey("ParentMessageId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("LeXun.Demo.Infos.Entities.MessageReply", "ParentReply")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("LeXun.Demo.Systems.Entities.AuditEntity", b =>
                {
                    b.HasOne("LeXun.Demo.Systems.Entities.AuditOperation", "Operation")
            ...
            modelBuilder.Entity("LeXun.Demo.Systems.Entities.AuditProperty", b =>
                {
                    b.HasOne("LeXun.Demo.Systems.Entities.AuditEntity", "AuditEntity")
                        .WithMany("Properties")

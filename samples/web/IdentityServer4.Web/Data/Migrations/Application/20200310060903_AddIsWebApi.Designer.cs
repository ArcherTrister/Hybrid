...
namespace IdentityServer4.Web.Data.Migrations.Application
{
    ...
    [Migration("20200310060903_AddIsWebApi")]
    partial class AddIsWebApi
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hybrid.Web.Identity.Entities.LoginLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Hybrid.Web.Identity.Entities.Organization", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Hybrid.Web.Identity.Entities.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Hybrid.Web.Identity.Entities.RoleClaim", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Hybrid.Web.Identity.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Hybrid.Web.Identity.Entities.UserClaim", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Hybrid.Web.Identity.Entities.UserDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Hybrid.Web.Identity.Entities.UserLogin", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Hybrid.Web.Identity.Entities.UserRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Hybrid.Web.Identity.Entities.UserToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Hybrid.Web.Identity.Entities.LoginLog", b =>
                {
                    b.HasOne("Hybrid.Web.Identity.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Hybrid.Web.Identity.Entities.Organization", b =>
                {
                    b.HasOne("Hybrid.Web.Identity.Entities.Organization", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Hybrid.Web.Identity.Entities.RoleClaim", b =>
                {
                    b.HasOne("Hybrid.Web.Identity.Entities.Role", "Role")
                        .WithMany("RoleClaims")
            ...
            modelBuilder.Entity("Hybrid.Web.Identity.Entities.UserDetail", b =>
                {
                    b.HasOne("Hybrid.Web.Identity.Entities.User", "User")
                        .WithOne("UserDetail")
                        .HasForeignKey("Hybrid.Web.Identity.Entities.UserDetail", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });

...
namespace ESoftor.WebApi.Controllers
{
    ...
    public class IdentityController : ControllerBase
    {
        ...
        //    OperationResult<string> token = await _identityService.(dto);
        ...
        public async Task<IActionResult> CheckSignature()
        {
            ...
            string[] ArrTmp = { AppSettingsManager.Get("ESoftor:Jwt:Secret"), timestamp, nonce };
            ...
            if (tmpStr == signature)
            {
                var json = new
                {
                    appid = AppSettingsManager.Get("Authentication:WeChat:AppId"),//AppKey
                    timestamp,
                    nonceStr = nonce,
                    signature
                };

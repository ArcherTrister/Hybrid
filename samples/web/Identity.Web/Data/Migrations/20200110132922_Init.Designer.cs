...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ESoftor.Web.Identity.Entity.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d50d2882-48fe-48ea-96f5-99a385ac6cd6"),
                            CreatedTime = new DateTime(1970, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            IsDeleted = false,
                            IsLocked = false,
            ...
            modelBuilder.Entity("ESoftor.Web.Systems.Entities.AuditEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ESoftor.Web.Systems.Entities.AuditOperation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ESoftor.Web.Systems.Entities.AuditProperty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ESoftor.Web.Systems.Entities.AuditEntity", b =>
                {
                    b.HasOne("ESoftor.Web.Systems.Entities.AuditOperation", "Operation")
            ...
            modelBuilder.Entity("ESoftor.Web.Systems.Entities.AuditProperty", b =>
                {
                    b.HasOne("ESoftor.Web.Systems.Entities.AuditEntity", "AuditEntity")
                        .WithMany("Properties")
